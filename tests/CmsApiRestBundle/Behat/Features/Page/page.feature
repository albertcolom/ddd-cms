Feature: Page endpoint
  ...
  Scenario: Create a new post
    When I send a "POST" on "page" with:
    """
    {
  ...
  Scenario: Get an existent page
    When I send a "GET" request on "page/03c81538-ce87-40b1-910a-aed3035c19d1"
